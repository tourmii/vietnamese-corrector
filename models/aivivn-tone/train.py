...
from dataset import Seq2SeqDataset, PAD, tgt_field_name, Seq2SeqNewsData
...
def load_data_custom_csv(train_csv, val_csv, batch_size=64, save_path="checkpoint"):
    # prepare dataset
    print("Reading data...")
    train = Seq2SeqNewsData.from_file(train_csv)

    print("Building vocab...")
    train.build_vocab(max_size=300)

    val = Seq2SeqNewsData.from_file(val_csv, share_fields_from=train)
...
if __name__ == "__main__":
    ...
    # import pandas as pd
    # data = pd.read_csv("/home/nvidia-lab/ai4life/kienpt/vietnamese-corrector/dataset/old_news_vn_1_sentences_split.csv")
    from datasets import load_dataset

    train_dataset = load_dataset("tourmii/vietnamese-corrector-errors", split="train")
    test_dataset  = load_dataset("tourmii/vietnamese-corrector-errors", split="test")
    ...
    # train
    # trainer.train(train_parts, val, val_iterator, batch_size)
    trainer.train(train_iterator, val_iterator)
