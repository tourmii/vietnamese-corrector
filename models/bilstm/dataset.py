...
def _read_corpus_csv(dataframe):
    if 'noisy' in dataframe.columns.tolist():
        src_list = dataframe["noisy"].astype(str).tolist()
        tgt_list = dataframe["gt"].astype(str).tolist()
    elif 'input_text' in dataframe.columns.tolist():
        src_list = dataframe["input_text"].astype(str).tolist()
        tgt_list = dataframe["target_text"].astype(str).tolist()
    else:
        raise ValueError("Noisy and gt columns not found in dataframe")
